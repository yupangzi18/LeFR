...
#define NAMESPACE_FIELDS(x) x(lefr) x(ycsb)

#define YCSB_KEY_FIELDS(x, y) x(int32_t, Y_KEY)
#define YCSB_VALUE_FIELDS(x, y)                                                               \
    x(FixedString<YCSB_FIELD_SIZE>, Y_F01) y(FixedString<YCSB_FIELD_SIZE>, Y_F02)             \
        y(FixedString<YCSB_FIELD_SIZE>, Y_F03) y(FixedString<YCSB_FIELD_SIZE>, Y_F04)         \
            y(FixedString<YCSB_FIELD_SIZE>, Y_F05) y(FixedString<YCSB_FIELD_SIZE>, Y_F06)     \
                y(FixedString<YCSB_FIELD_SIZE>, Y_F07) y(FixedString<YCSB_FIELD_SIZE>, Y_F08) \
                    y(FixedString<YCSB_FIELD_SIZE>, Y_F09) y(FixedString<YCSB_FIELD_SIZE>, Y_F10)

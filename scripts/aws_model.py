...
for n in ns:
  ...
  for p in ps:
    for i in range(3):
      ...
      print('./bench_ycsb  --id=%d --servers="%s" --protocol=Star --partition_num=%d --partitioner=hash2 --threads=12 --read_write_ratio=90 --cross_ratio=%d --batch_size=1000 --batch_flush=200' % (id, cmd, 12*n, p))

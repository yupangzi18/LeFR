...
class TapirExecutor : public Executor<Workload, Tapir<typename Workload::DatabaseType>>

{
public:
    using base_type = Executor<Workload, Tapir<typename Workload::DatabaseType>>;

    using WorkloadType = Workload;
    using ProtocolType = Tapir<typename Workload::DatabaseType>;
    ...
    TapirExecutor(std::size_t coordinator_id, std::size_t id, DatabaseType &db,

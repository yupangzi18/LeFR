...
enum class GPACMessage {
    ...
    REPLICATE_CENTER_REQUEST,
    REPLICATE_CENTER_RESPONSE,
...
public:
    static std::size_t new_init_txn_message(Message &message, uint32_t type,
        ...
        /*
         * The structure of a init txn request: (type, coordinator id, partition
         * id, seed, startTime)
         */
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::INIT_TXN_REQUEST), message_size, 0, 0);
    ...
    static std::size_t new_redo_message(Message &message, uint32_t redo) {
        ...
        auto message_size = MessagePiece::get_header_size() + sizeof(uint32_t);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REDO_REQUEST), message_size, 0, 0);
        Encoder encoder(message.data);
        encoder << message_piece_header;
        encoder << redo;
        message.flush();
    ...
    static std::size_t new_scanreplica_message(Message &message, uint32_t scanreplica,
                                               uint64_t startTime) {
        /*
         * The structure of a scan replica request: (scan replica, start time)
         */
        auto message_size = MessagePiece::get_header_size() + sizeof(uint32_t) + sizeof(uint64_t);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::SCANREPLICA_REQUEST), message_size, 0, 0);
        Encoder encoder(message.data);
        encoder << message_piece_header;
        encoder << scanreplica;
        encoder << startTime;
    ...
    static std::size_t new_read_replication_message(Message &message, ITable &table,
                                                    ...
                                                    uint64_t tid) {
        /*
         * The structure of a read replication request: (primary key, field
         * value, tid)
         */
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::READ_REPLICATION_REQUEST), message_size,
    ...
    static std::size_t new_write_replication_message(Message &message, ITable &table,
                                                     const void *key, const void *value) {
        /*
         * The structure of a write replication request: (primary key, field
         * value)
         */
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::WRITE_REPLICATION_REQUEST), message_size,
            table.tableID(), table.partitionID());
    ...
    static std::size_t new_search_message(Message &message, ITable &table, const void *key,
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::SEARCH_REQUEST), message_size, table.tableID(),
            table.partitionID());
    ...
    static std::size_t new_lock_message(Message &message, ITable &table, const void *key,
        ...
        auto message_size = MessagePiece::get_header_size() + key_size + sizeof(key_offset) +
                            sizeof(round_count) + sizeof(coordinator_id);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::LOCK_REQUEST), message_size, table.tableID(),
            table.partitionID());
    ...
    static std::size_t new_read_validation_message(Message &message, ITable &table, const void *key,
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::READ_VALIDATION_REQUEST), message_size,
            table.tableID(), table.partitionID());
    ...
    static std::size_t new_abort_message(Message &message, ITable &table, const void *key) {
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::ABORT_REQUEST), message_size, table.tableID(),
            table.partitionID());
    ...
    static std::size_t new_write_message(Message &message, ITable &table, const void *key,
        ...
        /*
         * The structure of a write request: (primary key, field value, round
         * count, coordinator id, key offset)
         */
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::WRITE_REQUEST), message_size, table.tableID(),
            table.partitionID());
    ...
    static std::size_t new_replication_message(Message &message, ITable &table, const void *key,
        ...
        auto message_size = MessagePiece::get_header_size() + key_size + field_size +
                            ...
                            sizeof(key_offset);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REPLICATION_REQUEST), message_size, table.tableID(),
            table.partitionID());
    ...
    static std::size_t new_release_lock_message(Message &message, ITable &table, const void *key,
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::RELEASE_LOCK_REQUEST), message_size, table.tableID(),
            table.partitionID());
    ...
    static std::size_t new_sync_transaction_info_replication_message(Message &message,
                                                                     ...
                                                                     uint64_t seed) {
        /*
         * The structure of a sync transaction info replication request:
         *             (coordinator id, partition id, seed)
         */

        auto message_size = MessagePiece::get_header_size() + sizeof(uint32_t) +
                            sizeof(std::size_t) + sizeof(std::size_t) + sizeof(uint64_t);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::SYNC_TRANSACTION_INFO_REPLICATION_REQUEST),
            message_size, 0, 0);
        Encoder encoder(message.data);
        encoder << message_piece_header;
        encoder << type;
    ...
    static std::size_t new_create_sub_txn_message(Message &message, std::size_t coordinator_id,
        ...
        /*
         * The structure of a create sub txn request: (coordinator id, dest node
         * id, partition id, round count)
         */

        auto message_size = MessagePiece::get_header_size() + sizeof(std::size_t) +
                            sizeof(std::size_t) + sizeof(std::size_t) + sizeof(uint32_t);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::CREATE_SUB_TXN_REQUEST), message_size, 0, 0);
        Encoder encoder(message.data);
        encoder << message_piece_header;
        encoder << coordinator_id;
    ...
    static std::size_t new_add_remote_wset_message(Message &message, ITable &table, const void *key,
                                                   ...
                                                   std::size_t coordinator_id) {
        /*
         * The structure of an add to remote writeset request: (primary key,
         * field value, key offset key offset, round count, coordinator id)
         */
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::ADD_REMOTE_WSET_REQUEST), message_size,
            table.tableID(), table.partitionID());
    ...
    static std::size_t new_remote_lock_message(Message &message, std::size_t coordinator_id,
        ...
        /*
         * The structure of a remote lock request: (coordinator id, round count,
         * source coordinator id)
         */
        auto message_size = MessagePiece::get_header_size() + sizeof(std::size_t) +
                            sizeof(round_count) + sizeof(source_coordinator);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REMOTE_LOCK_REQUEST), message_size, 0, 0);
    ...
    static std::size_t new_remote_read_validation_message(Message &message,
                                                          ...
                                                          std::size_t source_coordinator) {
        /*
         * The structure of a remote read validate request: (coordinator id,
         * round count, source coordinator id)
         */
        auto message_size = MessagePiece::get_header_size() + sizeof(std::size_t) +
                            sizeof(round_count) + sizeof(source_coordinator);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REMOTE_READ_VALIDATION_REQUEST), message_size, 0, 0);
    ...
    static std::size_t new_remote_write_message(Message &message, std::size_t coordinator_id,
                                                ...
                                                uint64_t commit_tid) {
        /*
         * The structure of a remote write request: (coordinator id, round
         * count, source coordinator id, commit tid)
         */
        auto message_size = MessagePiece::get_header_size() + sizeof(std::size_t) +
                            sizeof(round_count) + sizeof(coordinator_id) + sizeof(commit_tid);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REMOTE_WRITE_REQUEST), message_size, 0, 0);
    ...
    static std::size_t new_remote_release_lock_message(Message &message, std::size_t coordinator_id,
                                                       uint64_t commit_tid) {
        /*
         * The structure of a remote release lock request: (coordinator id,
         * commit tid)
         */
        auto message_size =
            MessagePiece::get_header_size() + sizeof(std::size_t) + sizeof(uint64_t);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REMOTE_RELEASE_LOCK_REQUEST), message_size, 0, 0);
    ...
    static std::size_t new_remote_abort_message(Message &message, std::size_t coordinator_id) {
        ...
        auto message_size = MessagePiece::get_header_size() + sizeof(std::size_t);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REMOTE_ABORT_REQUEST), message_size, 0, 0);
    ...
    static std::size_t new_replicate_center_message(Message &message, ITable &table,
                                                    const void *key, uint32_t key_offset,
                                                    uint32_t round_count,
                                                    std::size_t coordinator_id, uint64_t tid) {
        /*
         * The structure of a replicate center request: (primary key, read key
         * offset, round count, coordinator id, tid)
         */

        auto key_size = table.key_size();

        auto message_size = MessagePiece::get_header_size() + key_size + sizeof(key_offset) +
                            sizeof(round_count) + sizeof(coordinator_id) + sizeof(tid);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REPLICATE_CENTER_REQUEST), message_size,
            table.tableID(), table.partitionID());
    ...
    static std::size_t new_sync_decision_message(Message &message, std::size_t coordinator_id,
        ...
        auto message_size =
            MessagePiece::get_header_size() + sizeof(std::size_t) + sizeof(uint64_t);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::SYNC_DECISION_REQUEST), message_size, 0, 0);
        Encoder encoder(message.data);
        encoder << message_piece_header;
        encoder << coordinator_id;
        encoder << tid;
...
class GPACMessageHandler {
    using Transaction = GPACTransaction<Database>;
...
public:
    static void init_txn_request_handler(
        ...
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::INIT_TXN_REQUEST));
        ...
        // LOG(INFO)<< "initialize a txn in the second nod";

        // prepare response message header
        auto message_size = MessagePiece::get_header_size();
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::INIT_TXN_RESPONSE), message_size, 0, 0);
    ...
    static void init_txn_response_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::INIT_TXN_RESPONSE));
    ...
    static void redo_request_handler(
        ...
        std::function<void(std::size_t, std::size_t)> init_sub_transaction,
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() == static_cast<uint32_t>(GPACMessage::REDO_REQUEST));
    ...
    static void scanreplica_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::SCANREPLICA_REQUEST));
    ...
    static void read_replication_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::READ_REPLICATION_REQUEST));
        ...
        auto message_size = MessagePiece::get_header_size();
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::READ_REPLICATION_RESPONSE), message_size, table_id,
            partition_id);
    ...
    static void read_replication_response_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::READ_REPLICATION_RESPONSE));
    ...
    static void write_replication_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::WRITE_REPLICATION_REQUEST));
        ...
        auto message_size = MessagePiece::get_header_size();
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::WRITE_REPLICATION_RESPONSE), message_size, table_id,
            partition_id);
    ...
    static void write_replication_response_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::WRITE_REPLICATION_RESPONSE));
    ...
    static void search_request_handler(
        ...
        std::function<void(std::size_t, std::size_t)> init_sub_transaction,
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() == static_cast<uint32_t>(GPACMessage::SEARCH_REQUEST));
    ...
    static void search_response_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::SEARCH_RESPONSE));
    ...
    static void lock_request_handler(
        ...
        std::function<void(std::size_t, std::size_t)> init_sub_transaction,
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() == static_cast<uint32_t>(GPACMessage::LOCK_REQUEST));
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::LOCK_RESPONSE), message_size, table_id,
            partition_id);
    ...
    static void lock_response_handler(
        ...
        std::function<void(std::size_t, std::size_t)> init_sub_transaction,
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() == static_cast<uint32_t>(GPACMessage::LOCK_RESPONSE));
        ...
        std::size_t index = txn->get_index_process_message_write(key_offset);
    ...
    static void read_validation_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::READ_VALIDATION_REQUEST));
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::READ_VALIDATION_RESPONSE), message_size, table_id,
            partition_id);
    ...
    static void read_validation_response_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::READ_VALIDATION_RESPONSE));
        ...
        SiloRWKey &readKey = txn->readSet[key_offset];
        std::size_t index = txn->get_index_process_message_read(key_offset);
    ...
    static void abort_request_handler(
        ...
        std::function<void(std::size_t, std::size_t)> init_sub_transaction,
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() == static_cast<uint32_t>(GPACMessage::ABORT_REQUEST));
    ...
    static void write_request_handler(
        ...
        std::function<void(std::size_t, std::size_t)> init_sub_transaction,
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() == static_cast<uint32_t>(GPACMessage::WRITE_REQUEST));
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::WRITE_RESPONSE), message_size, table_id,
            partition_id);
    ...
    static void write_response_handler(
        ...
        std::function<void(std::size_t, std::size_t)> init_sub_transaction,
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() == static_cast<uint32_t>(GPACMessage::WRITE_RESPONSE));
    ...
    static void replication_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::REPLICATION_REQUEST));
        ...
        auto message_size = MessagePiece::get_header_size() + sizeof(key_offset);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REPLICATION_RESPONSE), message_size, table_id,
            partition_id);
    ...
    static void replication_response_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::REPLICATION_RESPONSE));
        ...
        Decoder dec(inputPiece.toStringPiece());
        dec >> key_offset;
        std::size_t index = txn->get_index_process_message_write_2(key_offset);
    ...
    static void release_lock_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::RELEASE_LOCK_REQUEST));
    ...
    static void sync_transaction_info_replication_request_handler(
        ...
        auto message_size = MessagePiece::get_header_size();
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::SYNC_REPLICATION_PER_TRANSACTION_RESPONSE),
            message_size, 0, 0);
    ...
    static void create_sub_txn_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::CREATE_SUB_TXN_REQUEST));
    ...
    static void create_sub_txn_response_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::CREATE_SUB_TXN_RESPONSE));
    ...
    static void add_remote_wset_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::ADD_REMOTE_WSET_REQUEST));
    ...
    static void add_remote_wset_response_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::ADD_REMOTE_WSET_RESPONSE));
    ...
    static void remote_lock_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::REMOTE_LOCK_REQUEST));
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REMOTE_LOCK_RESPONSE), message_size, 0, 0);
    ...
    static void remote_lock_response_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::REMOTE_LOCK_RESPONSE));
        auto partitionNum = txn->partitioner.get_partition_num();
        DCHECK(inputPiece.get_message_length() == MessagePiece::get_header_size() +
    ...
    static void remote_read_validation_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::REMOTE_READ_VALIDATION_REQUEST));
        auto stringPiece = inputPiece.toStringPiece();
        ...
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REMOTE_READ_VALIDATION_RESPONSE), message_size, 0,
            0);
    ...
    static void remote_read_validation_response_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::REMOTE_READ_VALIDATION_RESPONSE));
    ...
    static void remote_write_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::REMOTE_WRITE_REQUEST));
        ...
        auto message_size = MessagePiece::get_header_size() + sizeof(coordinator_id) +
                            sizeof(uint32_t) * partitionNum;
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REMOTE_WRITE_RESPONSE), message_size, 0, 0);
    ...
    static void remote_write_response_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::REMOTE_WRITE_RESPONSE));
        auto partitionNum = txn->partitioner.get_partition_num();
        DCHECK(inputPiece.get_message_length() == MessagePiece::get_header_size() +
                                                      sizeof(std::size_t) +
                                                      sizeof(uint32_t) * partitionNum);
    ...
    static void remote_release_lock_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::REMOTE_RELEASE_LOCK_REQUEST));
        DCHECK(inputPiece.get_message_length() ==
               MessagePiece::get_header_size() + sizeof(std::size_t) + sizeof(uint64_t));
        auto stringPiece = inputPiece.toStringPiece();
    ...
    static void remote_abort_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::REMOTE_ABORT_REQUEST));
    ...
    static void replicate_center_request_handler(
        MessagePiece inputPiece, Message &responseMessage, ITable &table, Transaction *txn,
        Transaction *replicateTxn, Transaction *subTxn,
        std::function<void(uint32_t, std::size_t, std::size_t, uint64_t, uint64_t)>
            init_replicate_transaction,
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::REPLICATE_CENTER_REQUEST));
        ...
        DCHECK(inputPiece.get_message_length() ==
               MessagePiece::get_header_size() + key_size + sizeof(key_offset) +
                   sizeof(round_count) + sizeof(source_coordinator_id) + sizeof(center_tid));
        ...
        // prepare response message header
        auto message_size =
            MessagePiece::get_header_size() + value_size + sizeof(uint64_t) + sizeof(key_offset);
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::REPLICATE_CENTER_RESPONSE), message_size, table_id,
            partition_id);
        ...
        // read to message buffer, Tapir & GPAC use the local read tid
        auto tid = SiloHelper::read(row, dest, value_size);

        readKey.set_tid(center_tid);
        readSet.insert(readSet.begin(), readKey);

        encoder << center_tid << key_offset;

        responseMessage.flush();
    }

    static void replicate_center_response_handler(
        MessagePiece inputPiece, Message &responseMessage, ITable &table, Transaction *txn,
        Transaction *replicateTxn, Transaction *subTxn,
        std::function<void(uint32_t, std::size_t, std::size_t, uint64_t, uint64_t)>
            init_replicate_transaction,
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::REPLICATE_CENTER_RESPONSE));
        auto table_id = inputPiece.get_table_id();
        auto partition_id = inputPiece.get_partition_id();
        DCHECK(table_id == table.tableID());
        DCHECK(partition_id == table.partitionID());
    ...
    static void sync_decision_request_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::SYNC_DECISION_REQUEST));
        ...
        auto message_size = MessagePiece::get_header_size();
        auto message_piece_header = MessagePiece::construct_message_piece_header(
            static_cast<uint32_t>(GPACMessage::SYNC_DECISION_RESPONSE), message_size, 0, 0);
    ...
    static void sync_decision_response_handler(
        ...
        Partitioner &partitioner) {
        DCHECK(inputPiece.get_message_type() ==
               static_cast<uint32_t>(GPACMessage::SYNC_DECISION_RESPONSE));
    ...
    get_message_handlers() {
        ...
        v.push_back(replicate_center_request_handler);
        v.push_back(replicate_center_response_handler);

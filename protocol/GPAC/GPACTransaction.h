...
class GPACTransaction {
public:
    using MetaDataType = std::atomic<uint64_t>;
    using DatabaseType = Database;

    GPACTransaction(std::size_t coordinator_id, std::size_t partition_id, DatabaseType &db,
    ...
    virtual ~GPACTransaction() = default;
    ...
    std::size_t get_index_process_message_read(std::size_t value) {
        std::size_t index = 0;
    ...
    std::size_t get_index_process_message_write(std::size_t value) {
        std::size_t index = 0;
    ...
    std::size_t get_index_process_message_write_2(std::size_t value) {
        std::size_t index = 0;
